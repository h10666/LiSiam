...
COMMON_CFG['train'].update(
    {
        'backupdir': 'ocrnet_xception_df_train',
        'logfilepath': 'ocrnet_xception_df_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'ocrnet_xception_df_test',
        'logfilepath': 'ocrnet_xception_df_test/test.log',
        'resultsavepath': 'ocrnet_xception_df_test/ocrnet_xception_df_results.pkl'
    }
)
COMMON_CFG['val'].update(
    {
        'backupdir': 'ocrnet_xception_df_val',
        'logfilepath': 'ocrnet_xception_df_val/val.log',
        'resultsavepath': 'ocrnet_xception_df_val/ocrnet_xception_df_results.pkl'
    }
)
