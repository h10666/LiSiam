...
class BaseDataset(torch.utils.data.Dataset):
    def __init__(self, mode, logger_handle, dataset_cfg, **kwargs):
        ...
        self.transforms1 = Compose(self.constructtransforms(self.dataset_cfg['aug_opts_1']))
        self.transforms2 = Compose(self.constructtransforms(self.dataset_cfg['aug_opts_2']))
