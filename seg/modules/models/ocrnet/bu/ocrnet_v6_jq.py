...
################## add by wj
    ...
    def clsDecoder(self, feats, feats_mid):
        ...
        Q_feat = torch.mul(feats, preds_mask)
        sa_feats = self.ReLu(self.saE(self.SAFusion(Q_feat, feats)))
...
####################################
    ...
    def forward(self, x, targets=None, images2=None, targets2=None, losses_cfg=None):
        ...
        predsLabel = self.clsDecoder(self.featE(feats), feats_mid)
...
################ add by wj
        if self.mode == 'TRAIN' and targets!=None:
            ...
            predsLabel_2 = self.clsDecoder(self.featE(feats_2), feats_mid_2)
