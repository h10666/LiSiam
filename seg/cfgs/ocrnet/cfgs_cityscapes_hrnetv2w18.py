'''define the config file for cityscapes and hrnetv2-w18'''
...
COMMON_CFG['train'].update(
    {
        'backupdir': 'ocrnet_hrnetv2w18_cityscapes_train',
        'logfilepath': 'ocrnet_hrnetv2w18_cityscapes_train/train.log',
    }
)
COMMON_CFG['test'].update(
    {
        'backupdir': 'ocrnet_hrnetv2w18_cityscapes_test',
        'logfilepath': 'ocrnet_hrnetv2w18_cityscapes_test/test.log',
        'resultsavepath': 'ocrnet_hrnetv2w18_cityscapes_test/ocrnet_hrnetv2w18_cityscapes_results.pkl'
    }
)
